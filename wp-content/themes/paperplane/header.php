...
<head>
  ...
  <script src="<?php bloginfo('template_directory'); ?>/js/vendor/jquery.validate.js"></script>
  <script src="<?php bloginfo('template_directory'); ?>/js/vendor/select.js"></script>
  <script src="<?php bloginfo('template_directory'); ?>/js/vendor/reservations.js"></script>
  <script src="<?php bloginfo('template_directory'); ?>/js/vendor/reservations-validation.js"></script>
  <script src="<?php bloginfo('template_directory'); ?>/js/vendor/reservations-admin.js"></script>
